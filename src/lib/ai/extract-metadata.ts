...
export type ExtractedMetadata = z.infer<typeof productMetadataSchema>;
...
export async function extractProductMetadata(imageBase64: string): Promise<ExtractedMetadata> {
